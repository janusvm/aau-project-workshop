...
\section{Forberedelse Til Næste Workshop}

\begin{frame}{Forberedelse Til Næste Workshop}
  \begin{block}{Næste gang: Git}
    Vi skal bruge:
    \begin{itemize}
    \item GitHub-konto: \url{https://github.com}
    \item Gratis Pro-opgradering af GitHub-konto for studerende: \url{https://education.github.com/discount_requests/new}
    \item Git: \url{https://git-scm.com/downloads}
    \item Git-klient: \url{https://gitahead.com}
    \end{itemize}
  \end{block}
\end{frame}
